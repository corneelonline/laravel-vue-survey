  ...
  <div>
    <div v-if="shouldHaveOptions()" class="mt-2">
      ...
      <div
        ...
        class="text-xs py-3 text-center text-gray-600"
      >
      ...
      >
        ...
        <button
          ...
          class="h-6 w-6 rounded-full flex items-center justify-center border border-transparent transition-colors text-red-500 hover:border-red-100"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6"
