    ...
    <template v-slot:header>
      <div class="flex justify-between items-center">
        ...
        <router-link
          ...
          class="py-2 px-3 text-white bg-emerald-500 rounded-md hover:bg-emerals-600"
        >
          <svg
      ...
      >
        ...
        <div class="flex justify-between items-center mt-3">
          ...
          <button
            ...
            class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-red-500 focus:ring-offset-2 focus:ring-red-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
